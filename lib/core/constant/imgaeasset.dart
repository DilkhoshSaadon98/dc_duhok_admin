class AppImageAsset {
  ...
  //! Svg Image :
  static const String usersSvg = "$rootSvg/users.svg";
  static const String categoriesSvg = "$rootSvg/categories.svg";
  static const String itemsSvg = "$rootSvg/items.svg";
  static const String messagesSvg = "$rootSvg/messages.svg";
  static const String notificationsSvg = "$rootSvg/notifications.svg";
  static const String ordersSvg = "$rootSvg/orders.svg";
  static const String reportsSvg = "$rootSvg/reports.svg";
  //  static const String avatar = "$rootImages/avatar.png" ;
